...
@section('content')
	 <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-magic"></i>修改商品信息</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <div class="wizard-nav wizard-nav-vertical">
                        	...
                        	<li data-wzd-id="wzd_1c8pnm7u91h3bc92tu_2"><span><i class="icol-user"></i>修改用户信息</span></li>
                        	</ul>
						...
						@endif
                        <form action="/admin/user/{{$res['id']}}" method="post"  class="mws-form wzd-vertical wizard-form wizard-form-vertical" novalidate="novalidate">
                            {{method_field('PUT')}}
                            {{csrf_field()}}
                            <fieldset class="wizard-step mws-form-inline" data-wzd-id="wzd_1c8pnm7u91h3bc92tu_0" style="display: block;">
                                ...
                                <div id="" class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" name="username" class="required large" value="{{$res['username']}}">
                                    </div>
                                </div>
                                <div id="" class="mws-form-row">
                                    <label class="mws-form-label">用户密码 <span class="required">*</span></label>
                                    <div class="mws-form-item">
                                        <input type="password" name="password" class="required large" value="{{$res['password']}}">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <ul class="mws-form-list">
                                            <li><input id="male" checked="{{$res['status']}} == 0 ? true :''" name="status" value="0" class="required" type="radio"> <label for="male">关闭</label></li>
                                            <li><input id="female" checked="{{$res['status']}} == 1 ? true :''"  name="status" value="1" type="radio"> <label for="female">开启</label></li>
                                        </ul>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <ul class="mws-form-list">
                                            <li><input id="male"  checked="{{$res['auth']}} == 1 ? true :''" name="auth" value="1" class="required" type="radio"> <label for="male">超管理员</label></li>
                                            <li><input id="female" checked="{{$res['auth']}} == 2 ? true :''" name="auth" value="2" type="radio"> <label for="female">普通管理员</label></li>
                                            <li><input id="female" checked="{{$res['auth']}} == 3 ? true :''" name="auth" value="3" type="radio"> <label for="female">普通用户</label></li>
                                        </ul>
                                        <label class="error plain" generated="true" for="gender" style="display:none"></label>
                                    </div>
                                </div>
                            ...
                            <fieldset class="wizard-step mws-form-inline" data-wzd-id="wzd_1c8pnm7u91h3bc92tu_1" style="display: none;">
                            ...
                            <fieldset class="wizard-step mws-form-inline" data-wzd-id="wzd_1c8pnm7u91h3bc92tu_2" style="display: none;">
