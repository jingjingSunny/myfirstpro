                        ...
                        <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                            <thead>
                                <tr role="row">
                                	...
                                	<th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 266px;" aria-label="CSS grade: activate to sort column ascending">修改时间</th>
                        	...
                        	@foreach ($res as $k=>$v)
                        		...
                        		@endif
                                    ...
                                    <td class="">
                                        <a href="/admin/user/restores/{{$v['id']}}">恢复</a>
                                    	<form style="display: inline;" action="/admin/user/delete/{{$v['id']}}" method="get">
